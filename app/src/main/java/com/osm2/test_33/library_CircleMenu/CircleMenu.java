...
public class CircleMenu extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        partSize = minSize / 8; //10
        iconSize = partSize * 4 / 4; ///5
    ...
    private void drawCircleIcon(Canvas canvas) {
        ...
        selDrawable.setBounds(itemX - iconSize , itemY - iconSize , itemX + iconSize , itemY + iconSize ); /// / 2
    ...
    private void drawMainMenuIcon(Canvas canvas) {
        ...
        switch (status) {
            ...
            case STATUS_MENU_OPEN:
                ...
                break;
            case STATUS_MENU_OPENED:
                resetBoundsAndDrawIcon(canvas, closeMenuIcon, centerX, centerY, iconSize );
                break;
            case STATUS_MENU_CLOSE:
                resetBoundsAndDrawIcon(canvas, closeMenuIcon, centerX, centerY, itemIconSize );
                break;
            case STATUS_MENU_CLOSE_CLEAR:
                canvas.rotate(90 * (rFraction - 1), centerX, centerY);
                resetBoundsAndDrawIcon(canvas, openMenuIcon, centerX, centerY, itemIconSize );
                break;
            case STATUS_MENU_CANCEL:
